...
pub trait Collector: Sync + Send {
    ...
    fn collect_segment(
        ...
        let mut segment_collector = tracing::info_span!("tantivy_for_segment").in_scope(|| {
            self.for_segment(segment_ord, reader)
        })?;

        tracing::info_span!("tantivy_weight_for_each").in_scope(|| {
